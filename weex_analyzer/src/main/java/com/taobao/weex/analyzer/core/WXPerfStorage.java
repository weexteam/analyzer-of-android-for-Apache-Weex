...
public class WXPerfStorage {
    ...
    public @Nullable Performance getLatestPerformance(@Nullable String pageName){
    ...
    public @NonNull List<Performance> getPerformanceList(@Nullable String pageName) {
    ...
    private @Nullable static String fetchPageName(@NonNull WXSDKInstance instance,@NonNull Performance performance) {
